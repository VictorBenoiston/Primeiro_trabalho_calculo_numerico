...
# Utilizando o método da falsa posição para o intervalo [1; 1.75]:
...
print('Questao 01, intervalo [1; 1.75]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_03_3o_intervalo_falsa_posicao.xlsx")
