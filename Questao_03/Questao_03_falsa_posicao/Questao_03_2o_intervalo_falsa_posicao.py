...
# Utilizando o método da falsa posição para o intervalo [-2; -1.25]:
...
print('Questao 01, intervalo [-2; -1.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_03_2o_intervalo_falsa_posicao.xlsx")
