...
# Função utilizada: f(x) = 3cos(x)-e^x/3 // Intervalo: [-5; 2]// h: 0.75 // Precisão: 10^-5

tempo_inicial = time.time()

# Utilizando o método da falsa posição para o intervalo [-5; -4.25]:
...
def falsa_posicao():
    ...
    valores_b = [-4.25]  # Valores negativos
    a_aplicado = []
    b_aplicado =[]
    x_barra_aplicados = []
    x_barra = []
...
print('Questao 01, intervalo [-5; -4.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_03_1o_intervalo_falsa_posicao.xlsx")
