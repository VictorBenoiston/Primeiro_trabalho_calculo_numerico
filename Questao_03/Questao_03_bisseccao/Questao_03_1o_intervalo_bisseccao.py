...
# Utilizando o método da bisseccao para o intervalo [-5; -4.25]:
...
c_total = bisseccao()[1]
print('Questao 02, intervalo [-5; -4.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_03_1o_intervalo_bisseccao.xlsx")
