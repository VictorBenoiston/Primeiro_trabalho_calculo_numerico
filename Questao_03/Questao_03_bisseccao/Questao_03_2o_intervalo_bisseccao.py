...
# Utilizando o método da bisseccao para o intervalo [-2; -1.25]:
...
c_total = bisseccao()[1]
print('Questao 02, intervalo [-2; -1.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_03_2o_intervalo_bisseccao.xlsx")
