...
# Utilizando o método da Secante para o intervalo [-2; -1.25]:
...
x_barra_0 = test(-2)  # -1.2935522707202982
x_barra_1 = test(-1.25)    # 0.8504654882324093 """


def secante():
    c = 2
    x_barra = [-2, -1.25]  # Os dois vlores iniciais são os dois extremos de I
    x_barra_aplicado = [-1.2935522707202982, 0.8504654882324093]
    def funcao_iteracao():
...
print('Questao teste, intervalo [-2; -1.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_03_2o_intervalo_secante.xlsx")
