...
# Utilizando o método da falsa posição para o intervalo [-1.5; -1.25]:
...
print('Questao 01, intervalo [-1.5; -1.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_02_1o_intervalo_falsa_posicao.xlsx")
