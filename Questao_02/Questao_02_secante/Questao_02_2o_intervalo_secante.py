...
# Utilizando o método da Secante para o intervalo [1; 1.25]:
...
x_barra_0 = test(1)  # -2
x_barra_1 = test(1.25)    # 2.01171875"""


def secante():
    c = 2
    x_barra = [1, 1.25]  # Os dois vlores iniciais são os dois extremos de I
    x_barra_aplicado = [-2, 2.01171875]
    def funcao_iteracao():
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_02_2o_intervalo_secante.xlsx")
