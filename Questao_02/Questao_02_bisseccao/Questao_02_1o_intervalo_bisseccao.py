...
# Utilizando o método da bisseccao para o intervalo [-1.5; -1.25]:
...
c_total = bisseccao()[1]
print('Questao 02, intervalo [-1.5; -1.25]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_02_1o_intervalo_bisseccao.xlsx")
