...
# Chute inicial entre o intervalo // Intervalo = [-5; -4.5] // f(x) = cos(x) + e^x // função de iteração = ln(-cos(x))
# Precisão = 10^-7
...
#     c = 0
#     x_barra = [-4.75]
#     x_aplicado = []    # Adotei como x0 o valor de -4.75 (Meio do intervalo)
#     while True:
...
# x_barra na função de iteração, o valor obtido não pertence ao intervalo [-5; -4.5]
