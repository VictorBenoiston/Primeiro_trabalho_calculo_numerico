...
# Utilizando o método de Newton para o intervalo [-2; -1.5]:
...
def newton():
    c = 0
    x_barra = [-1.75]  # O Xo é um chute inicial de qualquer valor no I. Nesse caso, o valor do meio
    x_aplicado = []
    while True:
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_01_2o_intervalo_newton.xlsx")
