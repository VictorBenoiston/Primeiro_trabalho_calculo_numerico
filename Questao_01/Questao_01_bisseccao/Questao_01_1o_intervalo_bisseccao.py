...
# Utilizando o método da bisseccao para o intervalo [-5; -4.5]:
...
def bisseccao():
    c = 0
    valores_a = [-5]  # Valores positivos
    valores_b = [-4.5]  # Valores negativos
    x_barra_aplicados = []
    x_barra = []
    while True:
...
c_total = bisseccao()[1]
print('Questao 01, intervalo [-5; -4.5]:')
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_01_1o_intervalo_bisseccao.xlsx")
