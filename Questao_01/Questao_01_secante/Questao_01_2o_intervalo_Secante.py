...
# Utilizando o método da Secante para o intervalo [-2; -1.5]:
...
x_barra_0 = test(-2)  # -0.2808115
x_barra_1 = test(-1.5)    # 0.2938673"""
...
def secante():
    c = 2
    x_barra = [-2, -1.5]  # Os dois vlores iniciais são os dois extremos de I
...
# Criando o arquivo
outWorkbook = xl.Workbook("Questao_01_2o_intervalo_secante.xlsx")
